...
- [x] **Step 3: Implement the normalized types and projection store**
...
- [x] **Step 4: Run projection tests and the existing Rust suite**
...
- [x] **Step 5: Commit the projection model**
...
- [x] **Step 1: Add failing transport tests with a fake child process**
...
- [x] **Step 3: Implement framed stdio JSON-RPC**
...
- [x] **Step 3: Implement lifecycle, compatibility, and notification mapping**
...
- [x] **Step 1: Add failing action and approval tests**
...
- [x] **Step 4: Register action commands and run the Rust suite**

Run: `cd src-tauri && cargo test --lib && cargo check`

Expected: all tests pass and no command accepts arbitrary JSON-RPC methods or payloads.

- [x] **Step 5: Commit local intervention**
...
- [x] **Step 1: Extract and test a pure merge function in Rust-backed frontend build scope**
...
- [x] **Step 2: Run TypeScript build and verify RED**

Run: `npm run build`

Expected: TypeScript compilation fails because bridge types and `mergeHexaSessions` do not exist.

- [x] **Step 3: Implement bridge loading, event subscriptions, and merge behavior**
...
- [x] **Step 4: Add restrained Hexa controls**
...
- [x] **Step 1: Add an ignored real app-server smoke test**
...
- [x] **Step 2: Run the smoke test and capture the initial failure**
...
- [x] **Step 3: Complete the public test harness and architecture documentation**
...
- [x] **Step 5: Run the real Codex smoke test**
...
- [x] **Step 6: Start HUMHUM and verify the live UI**
