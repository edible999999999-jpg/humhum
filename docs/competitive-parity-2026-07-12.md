...
- Rust: 123 passed, 4 ignored across the full suite. Frontend: 25 passed across 13 files. Production frontend build: passed.
...
4. Internet E2EE relay, smart push, attachments, encrypted history and multi-machine presence.
