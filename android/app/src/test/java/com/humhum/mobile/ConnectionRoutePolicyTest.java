...
public class ConnectionRoutePolicyTest {
    ...
    @Test
    public void aSuccessfulRelayRefreshKeepsFollowingControlsOffTheLanAddress() {
        BridgeConfig config = BridgeConfig.parse(
                "https://192.168.1.20:31276",
                "A1B2C3D4",
                "AA".repeat(32),
        ...
        Models.WakeRelayConfig relay = new Models.WakeRelayConfig(
                ...
                "55".repeat(32),
                "66".repeat(32));
        ConnectionStore.Connection localPairing = new ConnectionStore.Connection(
                config, "ab".repeat(32), Models.Scope.CONTROL, relay, false);

        assertTrue(ConnectionRoutePolicy.useRelayFirst(localPairing, true, true));
        assertFalse(ConnectionRoutePolicy.useRelayFirst(localPairing, true, false));
        assertFalse(ConnectionRoutePolicy.useRelayFirst(localPairing, false, true));
    }
}
